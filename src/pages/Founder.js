    ...
    <div className="container my-2">
      ...
      >
        ...
        <div className="col-lg-8 col-md-6 col-12 d-flex flex-column justify-content-center align-items-center text-center ">
          ...
          >
            தே.அரி அகிலன் <span className="fs-6 text-dark">ATS</span>
          </h2>
          <h6 className="text-secondary mb-2">நிறுவன தலைவர்</h6>
          <h6 className="fw-bold mb-1 fmain-tamil-title text-success">
            அகிலம் நண்பர்கள் அறக்கட்டளை
          </h6>
          <p className="text-secondary text-danger fs-6">தமிழ்நாடு</p>
        </div>
      </div>

      {/* Biography Section */}
      <div className="text-center mx-auto d-flex flex-column justify-content-center align-items-center text-center mb-3 p-2 shadow bg-white rounded-4 mt-4">
        ...
        <p className="mb-3" style={{ lineHeight: "1.8", textAlign: "justify" }}>
          🏙️ <strong>சென்னை ஈக்காட்டுத்தாங்கலில்</strong> உள்ள பிரபலமான ரியல்
          எஸ்டேட் நிறுவனமான <strong>SSLF City</strong> யின் <strong>President </strong> மற்றும்{" "}
          <br></br><strong>அகிலம் நண்பர்கள் அறக்கட்டளையின் நிறுவனரும்</strong> ஆகிய{" "}
          <strong>திரு தே.அரி அகிலன்</strong> அவர்கள், சென்னை மற்றும் அதை
        ...
        <p className="mb-3" style={{ lineHeight: "1.8", textAlign: "justify" }}>
          ...
          கிராமத்தில் வசிக்கும் விவசாய கூலித்தொழிலாளர்கள்{" "}
        ...
        <p className="mb-3" style={{ lineHeight: "1.8", textAlign: "justify" }}>
          ...
          சென்னையில் யாரையும் தெரியாத நிலையில் பேருந்து நிலையத்தில் தஞ்சமடைந்தார்.
          சுமார் ஆறு மாத காலமாக வெளியில் சென்று (டிரைனேஜ்) சாக்கடை சுத்தம்
          செய்வது மற்றும் கட்டுமான வேலை செய்துவிட்டு இரவு நேரங்களில் கோயம்பேடு
        ...
        <p className="mb-3" style={{ lineHeight: "1.8", textAlign: "justify" }}>
          🎂 பல வலிகளை சுமந்து வந்த அவர் <strong>12/05/2011</strong> அன்று,
        ...
        <p className=" fw-bold text-secondary text-center">
          ...
          🌏 இந்த மண்ணிற்கும் மக்களுக்கும் எல்லா உயிர்களுக்கும் நாம் உதவுவோம்.<br />
           <p className="text-danger mt-2 text-center">🤝 உறவாய் இணைவோம்! உலகை காப்போம்!</p>
        </p>
         {/* Social Icons */}
